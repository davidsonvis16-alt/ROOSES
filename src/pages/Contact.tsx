...
import { Mail, Phone, MapPin, Clock, Send, MessageSquare, Instagram, CheckCircle } from 'lucide-react';
...
export const Contact: React.FC = () => {
  ...
  const [activeLocation, setActiveLocation] = useState<'berlin' | 'paris'>('berlin');
    ...
    <div className="section-spacing">
      <div className="page-container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'start' }}>
          ...
          <div style={{ backgroundColor: 'var(--bg-secondary)', padding: '2.5rem', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border-light)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                ...
                <div style={{ padding: '1.5rem', border: '1px solid var(--border-light)', borderRadius: 'var(--radius-sm)' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
                    <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
                      <MapPin size={18} color="var(--accent-sage)" style={{ marginTop: '0.2rem' }} />
                      <div>Auguststraße 42, 10115 Berlin, Germany</div>
                    </div>
                    <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
                      <Phone size={18} color="var(--accent-sage)" />
                      <div>+49 30 8920 4110</div>
                    </div>
                    <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
                      <Mail size={18} color="var(--accent-sage)" />
                      <div>berlin@liebeandroses.com</div>
                    </div>
                    <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
                      <Clock size={18} color="var(--accent-sage)" style={{ marginTop: '0.2rem' }} />
            ...
            {/* Google Maps Minimal Custom View Placeholder */}
